...
local scheme = lush(function()
	...
	return {
		...
		Folded({ fg = colors.white, bg = colors.subtle25, gui = "italic" }),
		...
		DiffAdd({ fg = colors.green, bg = colors.subtle25, gui = "bold" }),
		DiffChange({ fg = colors.br_grey, bg = colors.subtle25 }),
		DiffDelete({ fg = colors.red, bg = colors.subtle25, gui = "bold" }),
		DiffText({ fg = colors.blue, bg = colors.subtle25 }),
