...
return lush(function()
	...
	return {
		...
		MiniStatuslineDevinfo({ fg = colors.white, bg = colors.subtle_yellow }),
		MiniStatuslineFilename({ fg = colors.yellow, bg = colors.subtle_yellow }),
		MiniStatuslineFileinfo({ fg = colors.white, bg = colors.subtle_yellow }),
		MiniStatuslineInactive({ fg = colors.grey, bg = colors.subtle10 }),
