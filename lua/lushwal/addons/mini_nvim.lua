...
return lush(function()
	...
	return {
		...
		MiniStatuslineDevinfo({ fg = colors.white, bg = colors.subtle50 }),
		MiniStatuslineFilename({ fg = colors.yellow, bg = colors.subtle50 }),
		MiniStatuslineFileinfo({ fg = colors.white, bg = colors.subtle50 }),
