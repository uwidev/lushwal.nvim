...
return lush(function()
	...
	return {
		...
		MiniStatuslineDevinfo({ fg = colors.white, bg = colors.subtle5 }),
		MiniStatuslineFileinfo({ fg = colors.yellow, bg = colors.subtle5 }),
		MiniStatuslineFilename({ fg = colors.yellow, bg = colors.subtle5 }),
		MiniStatuslineInactive({ fg = colors.white, bg = colors.subtle3 }),
